    ...
    <main className="flex flex-col items-center justify-center flex-1 w-full min-h-screen px-20 text-center bg-gray-200">
      ...
      <h1 className='as'>Asad</h1>
        ...
        <div className="flex flex-col items-center">
            ...
            <a href="" className="inline-block w-64 px-12 py-1 my-5 font-semibold text-white bg-blue-500 border-2 border-blue-500 rounded-full hover:bg-white hover:text-blue-500">Sign In</a>
        </div>
        </div>
        <div className="w-2/5 px-12 text-white bg-blue-500 py-36 rounded-tr-2xl rounded-br-2xl">
          ...
          <Link href="/signup" className="inline-block px-12 py-1 font-semibold border-2 border-white rounded-full hover:bg-white hover:text-blue-500">Sign Up</Link>
        </div>
      </div>
    </main>
